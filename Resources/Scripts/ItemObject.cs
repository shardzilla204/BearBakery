...
public partial class ItemObject : StaticBody2D
{
	...
	private void PlayerEntered()
	{
		...
		InRange = true;
		BearBakery.InventoryManager.ItemQueue.Insert(BearBakery.InventoryManager.ItemQueue.Count, this);
	}
	...
	{	
		InRange = false;
		_pickUpTimer.Stop();
		BearBakery.InventoryManager.ItemQueue.Remove(this);
	}
	...
	{
        return BearBakery.Player.Inventory.Items.Count >= BearBakery.InventoryManager.MaxSize;
    }
}