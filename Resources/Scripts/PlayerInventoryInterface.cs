...
public partial class PlayerInventoryInterface : Control
{
	...
	{
		BearBakery.InventoryManager.Slots = _inventorySlots.ToList();
    ...
    {
        if (BearBakery.InventoryManager.IsDragging && what == NotificationDragEnd) BearBakery.InventoryManager.IsDragging = false;
    }

	public override Variant _GetDragData(Vector2 atPosition)
	{
		BearBakery.InventoryManager.IsDragging = true;
